...
class ManualPaymentInstallmentController extends Controller
{
    public function submit(Request $request)
    {
        ...
        // Upload bukti
        $path = $request->file('payment_proof')->store('manual_payments');

        DB::transaction(function () use ($installments, $path) {
        ...
        return response()->json(['message' => 'Pembayaran manual dikirim. Menunggu verifikasi admin.']);
    }
}
